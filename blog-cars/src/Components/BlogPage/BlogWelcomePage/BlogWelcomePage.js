                        ...
                        <div className={style.tm_preview}>
                            ...
                            <div>
                                {isAdmin
                                    ...
                                    : <>{isPending ? <> Membership pending. <button onClick={() => cancelJoinRequest()} className={style.action} >Cancel request</button> </> : <button onClick={joinTeam} className={style.action}>Join team</button>}</>
                                }
                            </div>
                        </div>
